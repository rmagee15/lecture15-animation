    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch(action) {
            case (MotionEvent.ACTION_DOWN) : //put finger down
                ...
                view.addTouch(MotionEventCompat.getActionIndex(event), x, y);
...
//                view.ball.cy = y;
            ...
            case (MotionEvent.ACTION_POINTER_DOWN) :
                int pointerIndexDown = MotionEventCompat.getActionIndex(event);
                int pointerIdDown = MotionEventCompat.getPointerId(event, pointerIndexDown);
                view.addTouch(pointerIndexDown, x, y);
                Log.v(TAG, "additional finger down, this is finger " + Integer.toString(pointerIdDown));
                return true;
            case (MotionEvent.ACTION_POINTER_UP) :
                int pointerIndexUp = MotionEventCompat.getActionIndex(event);
                int pointerIdUp = MotionEventCompat.getPointerId(event, pointerIndexUp);
                view.removeTouch(MotionEventCompat.getActionIndex(event));
                Log.v(TAG, "additional finger up, this was finger " + Integer.toString(pointerIdUp));
                return true;
